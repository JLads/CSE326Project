...
import ASMR.GUI.StartTestPanel;

/**
 * a class for testing the pre-test StartTestPanel
 * @author nicholas
 *
 */
public class TestStartTestPanel {
	
	private static int widthShrink = 1000;
	private static int heightShrink = 500;
	
	public static void main(String args[]) {
		new TestStartTestPanel();
	}
	
	private TestStartTestPanel() {
		...
		try {
			SwingUtilities.invokeAndWait(new Runnable() {
				...
				public void run() {
					...
					frame.changePanel(new StartTestPanel());
